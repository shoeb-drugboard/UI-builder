...
import { Button, Drawer, DrawerBody, DrawerContent, DrawerFooter, DrawerHeader, Image, useDisclosure } from '@nextui-org/react';
...
const Cart = ({ className }: { className?: string }) => {
    ...
    return (
        <div className={cn('absolute h-screen w-screen', className)}>
            <Button className="capitalize absolute top-8 right-16 bg-primary text-white w-24 hover:bg-primary-dark transition-colors duration-300 overflow-auto" onPress={onOpen}>
